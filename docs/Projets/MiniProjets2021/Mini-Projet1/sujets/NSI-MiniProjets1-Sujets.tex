...
\end{lstlisting}
		...
		\item Écrire une fonction \texttt{max3(a, b)} qui renvoie le maximum des arguments entiers \texttt{a} et \texttt{b} sans utiliser la fonction \texttt{built-in}  \texttt{max}.
