...
%%Axiomes, Theoremes, Propriété, Définition, Methode, Preuve, Programme, Consignes




\newenvironment{consignes}
{\par \medskip   \begin{leftbar} \noindent \underline{\textbf{Consignes}}\hspace{0.5cm} \vspace*{10pt} \par }
...
\fancyhead[C]{\textbf{Mini-projet n°1}}
...
\begin{center}
\Large
\textbf{\fbox{Sujet 1 : niveau moyen}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet1.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
		\item Préparer une présentation orale de son travail devant le groupe (5 minutes).
	\item Barème sur 10 points :   2 points pour l'activité de recherche en classe (différencié par binôme), 1 point pour la qualité du code, 1 point pour le respect des consignes, 1 point pour les tests,  2 points pour la qualité du code, 1 point pour la correction du code, 2 points pour la prestation orale (différencié par binôme).
\end{itemize}

\end{consignes}


\begin{exercice}{Fonction et conditionnelles}

\begin{enumerate}
	\item Écrire une fonction \texttt{max2(a, b)} qui renvoie le maximum des arguments entiers \texttt{a} et \texttt{b} sans utiliser la fonction \texttt{built-in}  \texttt{max}.
...
\end{lstlisting}
		...
		\item Écrire une fonction \texttt{max3(a, b, c)} qui renvoie le maximum des arguments entiers \texttt{a} et \texttt{b} sans utiliser la fonction \texttt{built-in}  \texttt{max}.
...
\begin{exercice}{Boucle interactive}
...
\bcattention{} Interdiction d'utiliser les listes/tableaux Python.
...
\begin{center}
\Large
\textbf{\fbox{Sujet 2 : niveau moyen}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet2.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
...
\begin{enumerate}
\item  Écrire une fonction \texttt{bac(moyenne)}  qui prend en argument une moyenne de type \texttt{float} entre 0 et 20, vérifie si la moyenne est entre 0 et 20 avec une instruction \texttt{assert}  et renvoie  :
  
  \begin{itemize}
  \item  \texttt{True} si \texttt{moyenne >= 10} 
   \item \texttt{False} si \texttt{moyenne < 10}
   \end{itemize}


\item  Écrire une fonction \texttt{mention(moyenne)} qui prend en argument une moyenne de type \texttt{float} entre 0 et 20 et qui renvoie une chaîne de caractère :
	\begin{itemize}
\item \texttt{"recalé"} si  0 $\leqslant$ \texttt{note} $<$ 8
    \item \texttt{"second groupe"} si  8 $\leqslant$ \texttt{note} $<$ 10
    \item \texttt{"reçu"} si 10 $\leqslant$ \texttt{note} $<$ 12
    \item \texttt{"assez bien"} si 12 $\leqslant$ \texttt{note} $<$ 14
   \item \texttt{"bien"} si 14 $\leqslant$ \texttt{note} $<$ 16
    \item \texttt{"très bien"} si 16 $\leqslant$ \texttt{note} $\leqslant$ 20
    \item \texttt{"valeur incohérente"} sinon
	\end{itemize} 
...
Ensuite le programme demande à l'utilisateur de saisir chaque note et affiche en sortie la moyenne des notes saisies, arrondie au centième. On utilisera la fonction \texttt{round}, pour afficher sa documentation, saisir \texttt{help(round)} dans une console interactive.
...
\begin{center}
\Large
\textbf{\fbox{Sujet 3 : niveau moyen}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet3.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
...
\item Écrire une fonction prenant en paramètres les bornes de deux intervalles fermés $[a~;~b]$ et $[c~;~d]$ de $\mathbb{R}$ et qui renvoie \texttt{True} si leur intersection est non vide et \texttt{False} sinon. On donne ci-dessous la spécification de cette fonction. 
...
\item 
  Écrire une fonction prenant en paramètres les abscisses minimale et maximale et les ordonnées minimale et maximale de   deux rectangles du plan  et qui renvoie \texttt{True} si leur intersection est non vide et \texttt{False} sinon.  %Si les bords des rectangles se touchent, on considère que leur intersection est vide.
  \end{enumerate}
  
\begin{center}
	\includegraphics[scale=0.6]{images/rectangles.png}
\end{center}

\end{exercice}


\begin{exercice}{Boucles imbriquées et tortue}

Écrire avec le module \texttt{turtle} deux programmes permettant de réaliser les figures ci-dessous en au plus huit lignes (\texttt{from turtle import *}) compris.

\begin{minipage}{0.45\linewidth}
\begin{center}
\includegraphics[scale=1]{images/spirale.png}
\end{center}
\end{minipage}\hfill
\begin{minipage}{0.45\linewidth}
\begin{center}
\includegraphics[scale=1]{images/element.png}
\end{center}
\end{minipage}
...
\begin{center}
\Large
\textbf{\fbox{Sujet 4 : niveau moyen}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet4.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
...
\begin{methode}{Concaténation de chaînes de caractères}

\begin{itemize}[label=\ding{43}]
	\item On peut concaténer deux caractères avec l'opérateur \texttt{+} :
...
\end{lstlisting}
	...
	\item Si on concatène plusieurs fois le même caractère on peut utiliser l'opérateur de duplication \texttt{*}. On peut bien sûr combiner concaténation et duplication :
...
\begin{exercice}{Fonction et boucles}


Fournir des tests d'exécutions entre triple guillemets.

\begin{enumerate}

	\item Écrire une fonction 
 \texttt{carre(cote, caractere)} qui affiche un carré de côté passé en argument et  rempli du caractère passé dans le second argument. La fonction doit vérifier que \texttt{cote} est un entier positif  et provoquer une erreur sinon.
...
\end{lstlisting}
	...
	\item Écrire une fonction 
 \texttt{triangle\_rectangle\_gauche(cote, caractere)} qui affiche un triangle rectangle avec l'angle droit à gauche, rempli du caractère passé en argument et avec \texttt{cote} caractères sur chaque côté adjacent à l'angle droit.
...
\end{lstlisting}
 	...
 	\item Écrire une fonction 
 \texttt{triangle\_rectangle\_droite(cote, caractere)} qui affiche un triangle rectangle avec l'angle droit à droite, rempli du caractère passé en argument et avec \texttt{cote} caractères sur chaque côté adjacent à l'angle droit.
...
\item Écrire une fonction 
 \texttt{triangle\_isocele(base, caractere)} qui affiche un triangle isocèle  rempli du caractère passé en argument 
 et avec \texttt{base} caractères sur sa base.
...
\begin{enumerate}
	\item Écrire une fonction \texttt{sapin\_noel(base, tronc)} qui affiche un sapin dont le feuillage est un triangle isocèle rempli du caractère '*' avec \texttt{base} caractères sur sa base et son tronc est constitué de \texttt{tronc} caractères \texttt{'|'}. 
...
\item Écrire une fonction \texttt{losange(diagonale, caractere)} qui affiche un losange rempli du caractère passé en argument. La fonction doit vérifier que \texttt{diagonale} est un entier positif impair et provoquer une erreur sinon.
...
\begin{center}
\Large
\textbf{\fbox{Sujet 5 : niveau difficile}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet5.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
...
\begin{exercice}{Exercice 34 p. 46 du manuel Indice}
\end{exercice}
...
\begin{center}
\Large
\textbf{\fbox{Sujet 6 : niveau moyen}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet6.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
...
\begin{exercice}{Exercice 28 p. 44 du manuel Indice}
\end{exercice}
...
\begin{center}
\Large
\textbf{\fbox{Sujet 7 : niveau difficile}}
\end{center}
...
\begin{itemize}
	\item Déposer dans l'espace indiqué par M.Junier un script Python contenant les réponses aux deux exercices en le nommant selon le format \texttt{NOM1\_NOM2\_Sujet7.py}
	\item Insérer un commentaire avec les noms des deux membres du binôme au début du script.
	\item Respecter les consignes données dans chaque exercice.  
	\item Commenter les parties du code qui ne seraient pas immédiatement compréhensibles à la lecture.
	\item Fournir pour chaque question des tests permettant de vérifier la validité du code en les plaçant entre triple guillemets.
...
\begin{exercice}{Exercice 41 p. 47 du manuel Indice}
\end{exercice}
