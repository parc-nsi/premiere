...
1. Activité d'introduction pages 28 et 29 du manuel NSI Hachette. [Correction](../../chapitre1/exos/corrections/activp28/activitep28spyder.py) dans l'environnement [Idle](https://www.python.org/downloads/) ou [Thonny](https://thonny.org/).
